...
cart.click() #кликаем накнопку перейти в корзину
print("Enter Cart")
...
assert value_price_product_1 == value_cart_price_product_1 #сравниваем цену товара на витрине и в корзине
print("INFO Cart Product 1 GOOD! ")
...
#сверяем название продукта и цену с витроной и итоговым
